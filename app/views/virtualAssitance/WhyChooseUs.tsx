...
import { FeatureHighlightProps, HighlightReason } from '@/app/types/serviceType';
    ...
    <section className="bg-black px-6 py-20 text-white md:px-16">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-14 md:grid-cols-2 items-center">
        ...
        <div>
          ...
          <button className="mt-10 inline-flex items-center gap-3 rounded-lg bg-teal-500 px-6 py-3 font-semibold text-black transition hover:bg-teal-400">
            {buttonText}
