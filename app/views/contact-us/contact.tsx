...
const serviceData: ServiceItem[] = [
  {
    ...
    description:
      "Turn followers into loyal customers with a data-driven social strategy.",
    points: [
    ...
    image:
      "https://ncrisolutions.com/wp-content/uploads/2025/08/Social-Media-Management.webp",
    reverse: false,
  },
  {
    title: "Website Content & Design Development",
    description:
      "Your website is your digital storefront—it must impress, inform, and convert.",
    points: [
    ...
    image:
      "https://ncrisolutions.com/wp-content/uploads/2025/08/Website-Content-Design-Development.webp",
    reverse: true,
  },
];
...
const ContactPage: React.FC = () => {
  return (
    <div className="bg-black min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {supportLevels.map((level) => (
            <div
              key={level.id}
              className="bg-zinc-900/50 p-8 rounded-3xl border border-zinc-800 hover:border-teal-500/50 transition-all"
            >
      ...
      {/* CRITICAL: This ID must match the one used in 
          DynamicServiceSection's handleAction function 
      */}
