...
const Hero: React.FC = () => {
  return (
    ...
    <section className="relative h-[90vh] min-h-175 flex items-center overflow-hidden bg-black pt-20 lg:pt-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        ...
        >
          ...
          <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-xl">
            ...
            industries. Many businesses are already shining with our
