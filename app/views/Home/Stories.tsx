...
const stories: Story[] = [
  {
    ...
    challenges: [
      ...
      "Inefficient ad spend on unqualified leads.",
    ],
    solutions: [
      "Data-driven LinkedIn & Google targeting.",
      "Heatmap-based landing page optimization.",
  ...
  },
  {
    ...
    solutions: [
      ...
      "Reduced churn by 15% in 6 months.",
    ],
  },
  {
    id: 3,
    ...
    solutions: [
      "Integrated automated KYC verification.",
      ...
      <div className="relative z-10 max-w-7xl w-full">
        <header className="mb-16 text-center lg:text-left lg:px-12">
          ...
          <h2 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.1]">
            Global <span className="text-[#14b8a6]">Success</span>{" "}
            <br className="hidden md:block" /> Stories.
          </h2>
        </header>
        ...
        <div className="relative px-0 lg:px-12">
          <AnimatePresence mode="wait" custom={direction}>
            <motion.div
              ...
              className="bg-linear-to-br from-white/5 to-transparent backdrop-blur-3xl border border-white/10 rounded-[3rem] overflow-hidden grid grid-cols-1 lg:grid-cols-12 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)]"
            >
              {/* Image Container */}
              <div className="lg:col-span-5 relative h-75 lg:h-auto overflow-hidden">
                <motion.img
                  initial={{ scale: 1.1 }}
                  animate={{ scale: 1 }}
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-[#020a0a] via-transparent to-transparent opacity-80" />
                <div className="absolute top-10 left-10">
                  <span className="text-white/40 text-[10px] font-bold uppercase tracking-[0.3em] block mb-2">
                    Project Type
                  </span>
              ...
              <div className="lg:col-span-7 p-10 md:p-20 flex flex-col justify-center relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="space-y-6">
                    <h4 className="text-[#14b8a6] text-[10px] font-black uppercase tracking-[0.2em] border-b border-[#14b8a6]/20 pb-2">
                      The Challenge
                    </h4>
                  ...
                  <div className="space-y-6">
                    <h4 className="text-white text-[10px] font-black uppercase tracking-[0.2em] border-b border-white/20 pb-2">
                      Key Outcomes
                    </h4>
                    <ul className="space-y-4">
                      {stories[currentIndex].solutions.map((item, i) => (
                        <li
                          key={i}
                          className="text-gray-200 text-sm font-medium flex gap-3 italic"
                        >
                ...
                <div className="mt-16 pt-10 border-t border-white/5">
                  <button
                    ...
                    className="group flex items-center gap-3 text-sm font-bold tracking-widest uppercase hover:text-[#14b8a6] transition-colors"
                  >
                    Explore Details{" "}
