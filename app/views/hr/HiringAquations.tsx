      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-400 text-lg md:text-xl leading-relaxed mb-8 max-w-lg">
            Finding the right talent is the engine of growth.{" "}
            <strong>{companyName}</strong>
            delivers precision-driven recruitment, leveraging advanced
            psychometric testing and industry-specific vetting to find your next
            top performer.
          </p>
        ...
        >
          ...
          <div
            className="absolute -top-10 -right-10 w-64 h-64 bg-[#17B2AD] opacity-10 blur-[100px] rounded-full"
            aria-hidden="true"
          ></div>
