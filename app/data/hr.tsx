...
const hrData: HRService[] = [
  {
    ...
    description: "Managing payroll with compliance and accuracy is a challenge most businesses face. NCRI streamlines payroll through robust systems backed by certified experts, handling $500M in wages annually.",
    buttonText: "Simplify Payroll",
    image: "/path-to-payroll-img.jpg",
  ...
  },
  {
    ...
    description: "We help organizations build a culture of accountability and excellence by aligning individual goals with organizational objectives.",
    buttonText: "Boost Workforce Performance",
    image: "/path-to-performance-img.jpg",
  ...
  },
  {
    ...
    description: "Our certified organizational psychologists deliver scientifically validated tools to evaluate workforce potential. This helps organizations make data-driven talent decisions while improving team dynamics and employee engagement.",
    buttonText: "Build High-Performing Teams",
    image: "/path-to-psych-img.jpg",
